...
Logger.prototype.clear = function (before, after) {
  var files = this.getFiles.apply(this, arguments);
  files.forEach(function (file) {
    fs.unlink(file.path);
  });
  return files;
...
Logger.prototype.clearBefore = function (date) {
  var files = this.getFilesBefore.apply(this, arguments);
  files.forEach(function (file) {
    fs.unlink(file.path);
  });
  return files;
...
Logger.prototype.clearAfter = function (date) {
  var files = this.getFilesAfter.apply(this, arguments);
  files.forEach(function (file) {
    fs.unlink(file.path);
  });
  return files;
